...
1. 當陣列為空或是僅有單一元素，無法再分解更小，直接回傳陣列
...
let array = [2, 1, 5, 4, 4, 3, 8, 7, 9, 2, 1, 10, 9]
mergeSortBottomUp(array, <)   // [1, 1, 2, 2, 3, 4, 4, 5, 7, 8, 9, 9, 10]
/*:
...
*/
import Foundation
mergeSort(array, <)	// [1, 1, 2, 2, 3, 4, 4, 5, 7, 8, 9, 9, 10]
var testArr:[UInt32]  = {
	var array = [UInt32]()
	for _ in 0..<100 {
...
timeElapsedInSecondsWhenRunningCode(testCode4)
timeElapsedInSecondsWhenRunningCode(testCode5)
