...
![A sorted array is a valid heap](pics/SortedArray.png)
...
![The heap before insertion](pics/Heap1.png)
...
![The heap before insertion](pics/Insert1.png)
...
![The heap before insertion](pics/Insert2.png)
...
![The heap before insertion](pics/Insert3.png)
...
![The heap before removal](pics/Heap1.png)

What happens to the empty spot at the top?

![The root is gone](pics/Remove1.png)
...
![The last node goes to the root](pics/Remove2.png)
...
![The last node goes to the root](pics/Remove3.png)
...
![The last node goes to the root](pics/Remove4.png)
...
![We need to shift up](pics/Remove5.png)
