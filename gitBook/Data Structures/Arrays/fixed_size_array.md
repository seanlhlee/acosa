...
![An array with room for 10 elements](pics/array.png)
...
![Appending a new element](pics/append.png)

Looking up by index is also quick and easy:

![Indexing the array](pics/indexing.png)
...
![Insert requires a memory copy](pics/insert.png)
...
![Delete also requires a memory copy](pics/delete.png)
...
![Deleting just means copying one element](pics/delete-no-copy.png)
